...
def main(arguments: Sequence[str] | None = None) -> int:
    ...
    if options.check:
        ...
        for output, heart_rate, prototype in targets:
            generated = render_watchface(heart_rate=heart_rate, prototype=prototype)
    ...
    for output, heart_rate, prototype in targets:
        ...
        output.write_text(render_watchface(heart_rate=heart_rate, prototype=prototype), encoding="utf-8")
